...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department(new int(), "Fashion");
            Department d3 = new Department(new int(), "Books");
            Department d4 = new Department(new int(), "Electronics");

            Seller s1 = new Seller(new int(), "Bob", "Bob@gmail.com", new DateTime(1998, 4, 21), 1232.0, d1);
            Seller s2 = new Seller(new int(), "Ana", "Ana@gmail.com", new DateTime(1996, 4, 21), 1452.0, d2);
            Seller s3 = new Seller(new int(), "Sabrina", "Sabrina@gmail.com", new DateTime(1987, 4, 21), 1562.0, d3);
            Seller s4 = new Seller(new int(), "Rodrigo", "Rodrigo@gmail.com", new DateTime(1988, 4, 21), 1762.0, d4);
